...
protected:
	...
	void GetDialogTemplate(DLGTEMPLATE& dlgTemplate)
	{
		...
		dlgTemplate.cy=Sys::Convert::CentimetersToDlgUnitY(4.92125);
	...
	void InitializeGui()
	{
		...
		btOk.CreateX(NULL, L"Ok", WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_PUSHBUTTON | BS_CENTER | BS_VCENTER, 1.34938, 4.04812, 1.69333, 0.68792, hWnd, 1008);
		btCancel.CreateX(NULL, L"Cancel", WS_CHILD | WS_TABSTOP | WS_VISIBLE | BS_PUSHBUTTON | BS_CENTER | BS_VCENTER, 3.17500, 4.04812, 1.69333, 0.68792, hWnd, 1009);
